...
public:
  ...
  void SetSendMessageToUnity(SendMessage sm);		//Used for setting one way communication between Tracker and Unity
...
protected:
  ...
  //SLAMflex
  SendMessage sendStringToUnity;		//Used to send message to Unity
